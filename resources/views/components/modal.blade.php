...
{{--
    x-teleport ke body agar modal keluar dari semua stacking context
    (parent transform / filter / overflow / will-change yang bisa
    membuat z-index tidak efektif meski nilainya sudah 9999).
--}}
<template x-teleport="body">
    <div
        ...
        <div
            x-show="show"
            class="{{ $maxWidth }} relative w-full sm:mx-auto"
            x-transition:enter="ease-out duration-300"
